...
def get_report(cipher):
    ...
    encrypted = cipher.encrypt(plaintext, cipher.getKey(password, plaintext))
    decrypted = cipher.decrypt(encrypted, cipher.getKey(password, plaintext))
